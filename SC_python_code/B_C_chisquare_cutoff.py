...
def format_chi_square(seq, num_spline_steps,cutoff):
    chi_square_array=run_chi_square_test(1,num_spline_steps,cutoff)
...
def make_colormap(seq):
    ...
    chi_squares_full=format_chi_square(1,num_spline_steps,cutoff)
